...
BOOST_AUTO_TEST_CASE(strprintf_numbers)
{
    ...
    ptrdiff_t pt = 89983321; /* positive ptrdiff_t test value */
    ptrdiff_t spt = -89983321; /* negative ptrdiff_t test value */
    BOOST_CHECK(strprintf("%s %d %s", B, spt, E) == B" -89983321 " E);
    BOOST_CHECK(strprintf("%s %u %s", B, pt, E) == B" 89983321 " E);
