...
BOOST_AUTO_TEST_CASE( multiply )
{
    ...
    BOOST_CHECK((R2L * 0x89983321UL).ToString() == "23f7816e30c4ae2017257b7a0fa64d60402f5234d46e746b61c960d09a26d070");
    BOOST_CHECK((R1S * 0) == 0);
...
BOOST_AUTO_TEST_CASE( divide )
{
    ...
    BOOST_CHECK((R1L / D1L).ToString() == "00000000000000000b8ac01106981635d9ed112290f8895545a9983dde28fb3a");
