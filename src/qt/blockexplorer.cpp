...
static std::string ValueToString(CAmount nValue, bool AllowNegative = false)
{
    ...
    QString Str = BitcoinUnits::formatWithUnit(BitcoinUnits::EAZY, nValue);
...
{
    QString CSS = "body {font-size:12px; color:#f8f6f6; bgcolor:#258C76;}\n a, span { font-family: monospace; }\n span.addr {color:#258C76; font-weight: bold;}\n table tr td {padding: 3px; border: 1px solid black; background-color: #258C76;}\n td.d0 {font-weight: bold; color:#f8f6f6;}\n h2, h3 { white-space:nowrap; color:#258C76;}\n a { color:#FFFC00; text-decoration:none; }\n a.nav {color:#258C76;}\n";
