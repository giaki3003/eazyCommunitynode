...
public:
    ...
    void setZEazyControlLabels(int64_t nAmount, int nQuantity);
...
//    void coinControlClipboardChange();
    ...
    void on_pushButtonMintzEAZY_clicked();
    void on_pushButtonMintReset_clicked();
    void on_pushButtonSpentReset_clicked();
    void on_pushButtonSpendzEAZY_clicked();
    void on_pushButtonZEazyControl_clicked();
