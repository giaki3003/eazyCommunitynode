...
static Checkpoints::MapCheckpoints mapCheckpoints =
	...
	( 0, uint256("0x00000157fc7b9bb545590218839fdced8ece3837d6f0d84e4fc4aba75000c02d"))
	( 2, uint256("0x0000041e0dc336b386b238c95bde05ce967104f9fa130b83a82fc48a9c089a06"))
	( 999, uint256("0x04e198f673aa4bcfd84c3bd9fc1f945de43474b451ce05f7f2ad1c55c53265d0"))
	( 1999, uint256("0x63f1c33f53a122a7dadde5b7c987d586a58356cde3f03e8cf78a730e7c9d6578"))
	( 2999, uint256("0x7f747b9585f22bf020eb1b09b863d7a076bfe21ec7d9817d3154863385f05752"));
static const Checkpoints::CCheckpointData data = {
    &mapCheckpoints,
    1531631793, // * UNIX timestamp of last checkpoint block
    5085,    // * total number of transactions between genesis and last checkpoint
...
public:
    CMainParams()
    {
        ...
        vAlertPubKey = ParseHex("04a2d38b022aa92e83cbbf1d5c243bf367c395c6428268fefa98a4ef2124918a6b69b0c85ff8ec976d6a6bf7479396db777931a3d994540c27058b16b13dca9ea0");
        nDefaultPort = 9982;
        ...
        nZerocoinStartHeight = 49999;
        nAccumulatorStartHeight = 1;
        nZerocoinStartTime = 1531313663;
        nBlockEnforceSerialRange = 1; //Enforce serial range starting this block
        nBlockRecalculateAccumulators = ~1; //Trigger a recalculation of accumulators
        nBlockFirstFraudulent = ~1; //First block that bad serials emerged
        nBlockLastGoodCheckpoint = ~1; //Last valid accumulator checkpoint

        const char* pszTimestamp = "BBC News - Breaking news: first children saved from cave in thailand - 07/08/2018";
        CMutableTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        txNew.vin[0].scriptSig = CScript() << 486604799 << CScriptNum(4) << vector<unsigned char>((const unsigned char*)pszTimestamp, (const unsigned char*)pszTimestamp + strlen(pszTimestamp));
        txNew.vout[0].nValue = 0 * COIN;
        txNew.vout[0].scriptPubKey = CScript() << ParseHex("045517ed8b70800ac3457ad17c0b4c6bdb12f2e1fd2609bd669eccc9166e65eff0f6c14eeb21b7b674ee483e2c9c0eaa85a3b79734de454a17faa7f82389f6f218") << OP_CHECKSIG;
        genesis.vtx.push_back(txNew);
        genesis.hashPrevBlock = 0;
        genesis.hashMerkleRoot = genesis.BuildMerkleTree();
        genesis.nVersion = 1;
        genesis.nTime = 1531313663;
        genesis.nBits = 0x1e0ffff0;
        genesis.nNonce = 21985020;

        hashGenesisBlock = genesis.GetHash();
        assert(hashGenesisBlock == uint256("0x00000157fc7b9bb545590218839fdced8ece3837d6f0d84e4fc4aba75000c02d"));
        assert(genesis.hashMerkleRoot == uint256("0x4511c8eadb8583775ee9b51cfcb77c121f65acf3123ec7a8bb96f1cf156993b1"));

 	vSeeds.push_back(CDNSSeedData("eu1.eazynode.io", "eu1.eazynode.io"));
        vSeeds.push_back(CDNSSeedData("eu2.eazynode.io", "eu2.eazynode.io"));
        vSeeds.push_back(CDNSSeedData("na1.eazynode.io", "na1.eazynode.io"));
        vSeeds.push_back(CDNSSeedData("na2.eazynode.io", "na2.eazynode.io"));
        vSeeds.push_back(CDNSSeedData("sa1.eazynode.io", "sa1.eazynode.io"));
        vSeeds.push_back(CDNSSeedData("sa2.eazynode.io", "sa2.eazynode.io"));
...
public:
    CTestNetParams()
    {
        ...
        vFixedSeeds.clear();
        vSeeds.clear();
        //vSeeds.push_back(CDNSSeedData("testnet.eazy.io", "testnet.eazy.io"));         // Single node address
        //vSeeds.push_back(CDNSSeedData("testnet1.eazy.io", "testnet1.eazy.io"));       // Single node address
        //vSeeds.push_back(CDNSSeedData("testnet.eazycoin.org", "testnet.eazycoin.org"));       // Single node address


        base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1, 65); // Testnet eazy addresses start with 'x' or 'y'
        base58Prefixes[SCRIPT_ADDRESS] = std::vector<unsigned char>(1, 8);  // Testnet eazy script addresses start with '8' or '9'
