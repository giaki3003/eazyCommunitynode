...
Value getinfo(const Array& params, bool fHelp)
{
    if (fHelp || params.size() != 0)
        throw runtime_error(
            ...
            "  \"zEAZYsupply\" :\n"
            "  {\n"
            "     \"1\" : n,            (numeric) supply of 1 zEAZY denomination\n"
            "     \"5\" : n,            (numeric) supply of 5 zEAZY denomination\n"
            "     \"10\" : n,           (numeric) supply of 10 zEAZY denomination\n"
            "     \"50\" : n,           (numeric) supply of 50 zEAZY denomination\n"
            "     \"100\" : n,          (numeric) supply of 100 zEAZY denomination\n"
            "     \"500\" : n,          (numeric) supply of 500 zEAZY denomination\n"
            "     \"1000\" : n,         (numeric) supply of 1000 zEAZY denomination\n"
            "     \"5000\" : n,         (numeric) supply of 5000 zEAZY denomination\n"
            "     \"total\" : n,        (numeric) The total supply of all zEAZY denominations\n"
            "  }\n"
    ...
    for (auto denom : libzerocoin::zerocoinDenomList) {
        zeazyObj.push_back(Pair(to_string(denom), ValueFromAmount(chainActive.Tip()->mapZerocoinSupply.at(denom) * (denom*COIN))));
    }
    zeazyObj.emplace_back(Pair("total", ValueFromAmount(chainActive.Tip()->GetZerocoinSupply())));
    obj.emplace_back(Pair("zEAZYsupply", zeazyObj));
