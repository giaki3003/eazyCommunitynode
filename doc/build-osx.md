...
4.  (Optional) You can also install eazyd to your path:
...
Set the **Build directory** path to the `root` of the clone Eazy project. Qt Creator needs this to locate the `Makefile`.
...
To start debugging, locate the following function in `eazy.cpp` and set a breakpoint.
