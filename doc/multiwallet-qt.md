...
In order to support loading of multiple wallets in eazy-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is eazy.cpp.
...
Changes to eazy.cpp
----------------------
eazy.cpp is the entry point into eazy-qt, and as such, will require some minor modifications to provide hooks for
